...
alter table "public"."orders" add constraint "order_user_id_fkey" FOREIGN KEY (user_id) REFERENCES public.profiles(id) not valid;
...
CREATE TRIGGER on_auth_user_created AFTER INSERT ON auth.users FOR EACH ROW EXECUTE FUNCTION public.handle_new_user();
  ...
  create policy "ALLOW AUTH USERS qbyr7a_0"
  on "storage"."objects"
  as permissive
  for select
  to authenticated
using ((bucket_id = 'Product-images'::text));
  ...
  create policy "ALLOW AUTH USERS qbyr7a_1"
  on "storage"."objects"
  as permissive
  for insert
  to authenticated
